...
$email = $sql['email'];
$plan2 = $sql['plan'];
if($plan2 == 1100){ $plan1="Personal Healing on Akshar Reiki Healing Center";}
if($plan2 == 1110){ $plan1="Distance Healing";}
//if($plan2 == 8000){ $plan1="OFFLINE PRIVATE CLASS";}
$time1 = $sql['time'];
                ...
                <div class="col-md-9 col-sm-6">
                    ...
                    <div class="cause">
                        ...
                        <div class="cause-details">
                           <center>
                        <p><h3>Appointment booked for Akshar Reiki Healing <br>
...
<center><div class="col-md-6 col-sm-6">
                            ...
                            Appointment Type : <?php echo $plan1; ?><br>
                            Appointment Date : <?php echo $sql['date']; ?><br>
                            Appointment Time : <?php echo $time1; ?><br>
                            Appointment Fee : &#8377; <?php echo $sql['plan']; ?><br><br>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <?php $country = $sql['country'];
                            //if($country != "India")
                            if($country = $country){echo "<b>NOTE : All payment are non-refundable.</b><br>
                            <form action='https://www.paypal.com/cgi-bin/webscr' method='post' target='_top'>
<input type='hidden' name='cmd' value='_xclick'>
<input type='hidden' name='business' value='sakhihosting@gmail.com'>
<input type='hidden' name='lc' value='US'>
<input type='hidden' name='item_name' value='Reiki Healing Appointment'>
...
<table>
<tr><td><input type='hidden' name='on0' value='Service Name'>Payable Amount</td></tr><tr><td><select name='os0'>
	<option value='$plan2'> $plan1 &#8377; $plan2 INR</option>
</select> </td></tr>
</table>
<input type='hidden' name='option_select0' value='$plan2'>
<input type='hidden' name='option_amount0' value='1100.00'>
